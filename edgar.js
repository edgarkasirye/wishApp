          ...
          firebase
            ...
            .then(fcmToken => {
              if (fcmToken) {
                ...
                //once you've got the fcmToken you can save it in the  db
                // you are going to need it when you want to send a message
                ...
                firebase
                  ...
                  .then(
                    () => console.log("success saving token"),
                    err => {
                      console.log("failure saving the token");
                    }
                  );
  ...
  render() {
    return (
      <ScrollView style={{ flex: 1, backgroundColor: "#fff" }}>
            ...
            <View style={{ marginHorizontal: 10 }}>
              ...
              >
                <Image
                  ...
                  style={{ width: 60, height: 60, borderRadius: 30, margin: 2 }}
                />
              </TouchableOpacity>
        ...
        <Text style={{ fontSize: 20, marginHorizontal: 15, marginTop: 10 }}>
          Discover
        </Text>
        ...
        <View style={{ marginHorizontal: 10 }}>
          {this.state.users.map((item, index) => (
            <View style={{ marginVertical: 10 }}>
              <Image
                source={{ uri: item.avatarSource }}
                style={{ width: width - 20, height: 300, borderRadius: 15 }}
              />
              <View style={{ flexDirection: "row", marginVertical: 10 }}>
                ...
                >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.winkNotify(item.key, item.name, item.avatarSource)
                    }
                    style={{
                      borderRadius: 15,
                      width: 40,
